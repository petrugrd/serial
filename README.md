...
This library is in use in several robotics related projects and can be built and installed to the OS like most unix libraries with make and then sudo make install.
...
Get the code:
    ...
    git clone https://github.com/petrugrd/serial.git
